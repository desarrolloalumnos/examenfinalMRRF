...
const datatable = new Datatable('#tablaUsuarios', {
    ...
    columns: [
        ...
        },
        {
            ...
            searchable: false,
            orderable: false,
            render: (data, type, row, meta) => `<button class="btn btn-info" data-id='${data}' data-nombre='${row["usu_nombre"]}' data-dpi='${row["usu_dpi"]}'>Activar Usuario</button>`
        },
        {
            title: 'ELIMINAR',
            data: 'usu_id',
...
const buscar = async () => {
    ...
    const url = `/examenfinalMRRF/API/activacion/buscar`;
    const config = {
        method: 'GET'
    }
...
const activar = async e => {
    ...
    if (result.isConfirmed) {
        ...
        const url = `/examenfinalMRRF/API/activacion/activar`;
        const config = {
            method: 'POST',
            body,
        };
...
const eliminar = async e => {
    ...
    if (result.isConfirmed) {
        ...
        const url = `/examenfinalMRRF/API/activacion/eliminar`;
        const config = {
            method: 'POST',
            body,
        };
...
const asignarol = async () => {
    ...
    const url = `/examenfinalMRRF/API/activacion/asignarol`;
    const config = {
        method: 'POST',
        body,
    };
